...
import ItemTypeOrderItem from "@/components/DashboardComponents/ItemTypeOrderItem";

interface Props {
  orders: OrderItemObj[];
}
const ItemTypeOrderList: React.FC<Props> = ({ orders }) => {
...
export default ItemTypeOrderList;
