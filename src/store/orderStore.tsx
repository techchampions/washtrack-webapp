    ...
    (set) => ({
        ...
        try {
          ...
          if (response.data.success) {
            ...
            if (!response.data.response.success) {
              console.log(response.data.response.message, "------------error in add services------failed")
      ...
      deleteServices: async (id) => {
        ...
        try {
          ...
          console.log("API Response delete services:", response);
          ...
          console.error("Error delete services :", errorMessage); 
          set({
            error: errorMessage,
            isLoading: false,
          });
