...
const PageNotFound: React.FC = () => {
  ...
  return (
    <div className="min-h-[70vh] w-screen flex flex-col items-center justify-center">
      <div className="[--shadow:rgba(60,64,67,0.3)_0_1px_2px_0,rgba(60,64,67,0.15)_0_2px_6px_2px] w-xs sm:w-sm h-auto rounded-2xl bg-white [box-shadow:var(--shadow)] max-w-sm md:max-w-md mx-auto">
        <div className="flex flex-col items-center justify-between pt-9 px-6 pb-6 relative">
          <span className="relative mx-auto -mt-16 mb-8  border-2 border-gray-300 h-30 w-30 flex flex-col justify-center items-center bg-white rounded-full">
            <svg
            ...
            <div className="pt-2">404</div>
          </span>

          <h5 className="text-lg font-alaba-bold mb-2 text-center">
            Oops... Page Not Found!
          </h5>
          ...
          <div className="grid grid-cols-2 gap-2 text-sm w-full">
            ...
            <LinkButton
              href={"/"}
              className="flex items-center gap-2 bg-black text-white hover:bg-gray-800 p-2 rounded-full w-full justify-center"
              icon={<Home size={20} />}
              label="Go Home"
            />
          </div>
